...
function EdocumentIcon() {
  return <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M6 2h7l5 5v13a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 2v5h5" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 13h8" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 17h5" /></svg>;
}
function LogoutIcon() {
...
export const defaultMenuItems: MenuItem[] = [
    ...
    { id: 'edocument', label: 'E-Document', icon: <EdocumentIcon /> },
];

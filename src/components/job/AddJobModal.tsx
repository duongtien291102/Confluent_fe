...
// Calculate estimated hours based on working days (8 hours per working day)
...
const AddJobModal: React.FC<AddJobModalProps> = ({ isOpen, onClose, onSubmit, defaultManager = '' }) => {
    ...
    // Update estimated hours when dates change
    useEffect(() => {
    ...
    const handleEndDateChange = (date: string) => {
        ...
        if (date >= startDate) {
            ...
            // If user tries to select a date before start date, set it to start date
